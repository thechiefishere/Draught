...
public abstract class AbsPieceSprite extends AbsSprite2D{
	...
	private String computerKillDirection;
	...
	public boolean coolMoveToLeft()
	{
		...
		//System.out.println("presentPosition = " + presentPosition);
	...
	public String getComputerKillDirection() {
		return computerKillDirection;
	}

	public void setComputerKillDirection(String computerKillDirection) {
		this.computerKillDirection = computerKillDirection;
	}
}
